...
AmCharts.AmChart = AmCharts.Class({construct:function () {
    ...
    this.percentFormatter = {precision:2,
    ...
    var a = this.container, b = this.realWidth, d = this.realHeight, e =
        this.set, f = AmCharts.polygon(a, [0, b - 1, b - 1, 0], [0, 0, d - 1, d - 1], this.backgroundColor, this.backgroundAlpha, 1, this.borderColor, this.borderAlpha);
    this.background = f;
    e.push(f);
    ...
    a = {x:a, y:b, text:d, align:e, size:f, color:g, alpha:j, rotation:h, bold:k};
    ...
    if (d) {
        ...
        if ("right" == d || "left" == d)a -= f, 0 > a && (a = 0), h.width = a + "px", "left" == d ? h.left = AmCharts.findPosX(this.div) +
            f + "px" : e.left = a + "px", e.top = (b - g) / 2 + "px"
    }
    return a
    ...
    this.dispatchDataUpdated && (this.dispatchDataUpdated = !1, this.fire("dataUpdated", {type:"dataUpdated", chart:this}))
}, drb:function () {
...
//    }
    ...
    this.hideBalloon();
    var b = this.chartDiv;
    a.touches && (a = a.touches.item(0), this.mouseX =
        a.pageX - AmCharts.findPosX(b), this.mouseY = a.pageY - AmCharts.findPosY(b))
...
AmCharts.resetDateToMin = function (a, b, d, e) {
    void 0 == e && (e = 1);
    var f = a.getFullYear(), g = a.getMonth(), h = a.getDate(), j = a.getHours(), k = a.getMinutes(), l = a.getSeconds(), m = a.getMilliseconds(), a = a.getDay();
    switch (b) {
        case "YYYY":
            f = Math.floor(f / d) * d;
            g = 0;
...
AmCharts.formatNumber = function (a, b, d, e, f) {
    ...
    var g = b.decimalSeparator, b = b.thousandsSeparator, h = 0 > a ? "-" : "", a = Math.abs(a), j = a.toString();
    if (-1 == j.indexOf("e")) {
...
AmCharts.dayNames = "Domingo Lunes Martes Miércoles Jueves Viernes Sábado".split(" ");
AmCharts.shortDayNames = "Dom Lun Mar Mie Jue Vie Sab".split(" ");
AmCharts.monthNames = "Enero Febrero Marzo Abril Mayo Junio Julio Agosto Setiembre Octubre Noviembre Diciembre".split(" ");
AmCharts.shortMonthNames = "Ene Feb Mar Abr May Jun Jul Ago Set Oct Nov Dic".split(" ");
...
AmCharts.Bezier = AmCharts.Class({construct:function (a, b, d, e, f, g, h, j, k, l) {
    var m = "none";
    void 0 != k && (m = k);
    "object" == typeof h && (h = h[0]);
    "object" == typeof j && (j = j[0]);
    g = {fill:h, "fill-opacity":j, "stroke-dasharray":m, "stroke-width":g};
    isNaN(f) || (g["stroke-opacity"] = f);
    e && (g.stroke = e);
    e = "M" + Math.round(b[0]) + "," + Math.round(d[0]);
    f = [];
    for (h = 0; h < b.length; h++)f.push({x:b[h], y:d[h]});
    ...
    var f = Math.round, g = this.getPointOnSegment(a, b, 0.75), h = this.getPointOnSegment(e, d, 0.75), j = (e.x - a.x) / 16, k = (e.y - a.y) / 16, l = this.getPointOnSegment(a, b, 0.375), a = this.getPointOnSegment(g, h, 0.375);
    a.x -= j;
    a.y -= k;
...
AmCharts.Cuboid = AmCharts.Class({construct:function (a, b, d, e, f, g, h, j, k, l, m, p, q) {
    this.set = a.set();
    this.container = a;
    this.h = Math.round(d);
    this.w = Math.round(b);
    ...
    var a = this.set;
    a.clear();
    var b = this.container, d = this.w, e = this.h, f = this.dx, g = this.dy, h = this.colors, j = this.alpha, k = this.bwidth,
        l = this.bcolor, m = this.balpha, p = this.gradientRotation, q = this.cornerRadius;
    if (0 < f || 0 < g) {
        var n = h, o = h;
        "object" == typeof h && (n = h[0], o = h[h.length - 1]);
        var r = AmCharts.adjustLuminosity(n, -0.2), r = AmCharts.adjustLuminosity(n, -0.2), n = AmCharts.polygon(b, [0, f, d + f, d, 0], [0, g, g, 0, 0], r, j, 0, 0, 0, p);
        ...
        if (0 < Math.abs(e) && 0 < Math.abs(d)) {
            ...
            var x =
                AmCharts.polygon(b, [0, 0, f, f, 0], [0, e, e + g, g, 0], r, j, 0, 0, 0, p), y = AmCharts.polygon(b, [d, d, d + f, d + f, d], [0, e, e + g, g, 0], r, j, 0, 0, 0, p);
    ...
    1 > Math.abs(e) && (e = 0);
    1 > Math.abs(d) && (d = 0);
    b = 0 == e ? AmCharts.line(b, [0, d], [0, 0], l, m, k) : 0 == d ? AmCharts.line(b, [0, 0], [0, e], l, m, k) : 0 < q ? AmCharts.rect(b, d, e, h, j, k, l, m, q,
        p) : AmCharts.polygon(b, [0, 0, d, d, 0], [0, e, e, 0, 0], h, j, k, l, m, p);
    ...
    var b = a.totalFrames;
    a.frame <= b && (b =
        a.easing(0, a.frame, 1, a.rh - 1, b), a.height(b), setTimeout(function () {
...
AmCharts.AmLegend = AmCharts.Class({construct:function () {
    ...
    setData:function (a) {
        ...
        this.titleWidth = 0;
        if (f = this.title)a = AmCharts.text(this.container, f, this.color, a.fontFamily, this.fontSize, "start", !0), a.translate(0, this.marginTop +
            this.verticalGap + this.ly + 1), a = a.getBBox(), this.titleWidth = a.width + 15, this.titleHeight = a.height + 6;
        ...
        var a = this.position, b = this.marginLeft + this.titleWidth, d = this.marginRight, e = this.marginTop, f = this.marginBottom, g = this.horizontalGap, h = this.div, j = this.divWidth, k = this.maxColumns, l = this.verticalGap, m = this.spacing,
            p = j - d - b, q = 0, n = 0, o = this.container, r = o.set();
        this.set = r;
        o = o.set();
        r.push(o);
        for (var s = this.entries, t = 0; t < s.length; t++) {
            var u = s[t].getBBox(), x = u.width;
            x > q && (q = x);
            u = u.height;
            u > n && (n = u)
        }
        ...
        var a = this.markerSize - 3, b = {stroke:this.switchColor,
            "stroke-width":3}, d = this.container, e = AmCharts.line(d, [3, a], [3, a]).attr(b), a = AmCharts.line(d, [3, a], [a, 3]).attr(b);
        return this.container.set([e, a])
    }, createMarker:function (a, b, d) {
        var e = this.markerSize, f = this.container, g, h = this.markerBorderThickness, j = this.markerBorderAlpha;
        switch (a) {
            case "square":
            ...
            case "dashedLine":
                g =
                    AmCharts.line(f, [0, e], [e / 2, e / 2], b, d, h, 3);
                break;
            case "triangleUp":
...
AmCharts.AmBalloon = AmCharts.Class({construct:function () {
    ...
    if (!isNaN(a)) {
        ...
        if (this.show) {
            ...
            this.color == l && (l = null);
            var m = this.balloonColor, p = this.fillColor, q = this.borderColor;
            void 0 != m && (this.adjustBorderColor ? q = m : p = m);
            var n = this.horizontalPadding, o = this.verticalPadding, m = this.pointerWidth, r = this.pointerOrientation, s = this.cornerRadius, t = d.fontFamily, u = this.fontSize;
            ...
            l < g && (l = g);
            l + n > j && (l = j - n);
            0 < s || 0 == m ? (q = AmCharts.rect(e, n, f, p, this.fillAlpha, this.borderThickness, q,
...
AmCharts.AmCoordinateChart = AmCharts.Class({inherits:AmCharts.AmChart, construct:function () {
    ...
    if (d) {
        ...
        if (e)var f = AmCharts.extractPeriod(this.categoryAxis.minPeriod), g = f.period, f = f.count;
        var h = {};
        this.lookupTable = h;
        for (var j = 0; j < d.length; j++) {
            var k = {}, l = d[j], m = l[this.categoryField];
            k.category = m;
            h[l[b]] = k;
            e && (m = new Date(m.getFullYear(), m.getMonth(), m.getDate(), m.getHours(), m.getMinutes(), m.getSeconds(), m.getMilliseconds()), m = AmCharts.resetDateToMin(m,
                g, f), k.category = m, k.time = m.getTime());
            ...
            for (var q = 0; q < p.length; q++) {
                ...
                for (var o = 0; o < a.length; o++) {
                    var m = a[o], r = m.id, s = m.periodValue;
                    if (m.valueAxis.id == n) {
                        k.axes[n].graphs[r] = {};
                        var t = {};
                        t.index = j;
    ...
    processValues:function (a, b, d) {
        ...
        for (var e = 0; e < b.length; e++) {
            var f = b[e], g = this.lookupTable["" + f[d]], h = a.valueAxis.id;
            g && (h = g.axes[h].graphs[a.id],
                h.serialDataItem = g, h.values = this.processValues(f, a, a.periodValue), this.processFields(a, h, f))
        }
        ...
        if (a = a.dataItem) {
            ...
            switch (b) {
                case "clickMarker":
                    e ?
                        this.hideGraphsBalloon(a) : this.showGraphsBalloon(a);
                    break;
                case "clickLabel":
        ...
        this.legend &&
        (alpha = this.legend.rollOverGraphAlpha);
        ...
        var a = this.graphs;
        if (a)for (var b = 0; b < a.length; b++)a[b].animationPlayed =
            !1
    }});
AmCharts.AmRectangularChart = AmCharts.Class({inherits:AmCharts.AmCoordinateChart, construct:function () {
    ...
    b = g - d;
    for (var l = 0; l < a.length; l++)b = this.getAxisBounds(a[l],
    ...
    var a = this.dx, b = this.dy, d = this.marginLeftReal, e = this.marginTopReal, f = this.plotAreaWidth, g = this.plotAreaHeight, h = this.plotAreaFillColors, j = this.plotAreaFillAlphas, k = this.plotAreaBorderColor, l = this.plotAreaBorderAlpha;
    ...
    a.width =
        this.plotAreaWidth * this.widthMultiplyer;
    ...
    "top" == a.position ? b ? this.marginLeftReal +=
        d : this.marginTopReal += d : b ? this.marginRightReal += d : this.marginBottomReal += d
...
AmCharts.TrendLine = AmCharts.Class({construct:function () {
    ...
    var a = this;
    a.destroy();
    var b = a.chart, d = b.container, e, f, g, h, j = a.categoryAxis, k = a.initialDate, l = a.initialCategory, m = a.finalDate, p = a.finalCategory, q = a.valueAxis, n = a.valueAxisX, o = a.initialXValue, r = a.finalXValue, s = a.initialValue, t = a.finalValue, u = q.recalculateToPercents;
    j && (k && (e = j.dateToCoordinate(k)), l && (e =
        j.categoryToCoordinate(l)), m && (f = j.dateToCoordinate(m)), p && (f = j.categoryToCoordinate(p)));
...
AmCharts.AmSerialChart = AmCharts.Class({inherits:AmCharts.AmRectangularChart, construct:function () {
    ...
    updateCategoryAxis:function () {
        ...
        for (var a = 0, b = this.valueAxes.length, d = this.graphs.length, e, f, g = !1, h, j = 0; j < b; j++) {
            ...
            if ("none" == k || "3d" == k)for (h = 0; h < d; h++)e = this.graphs[h], !e.hidden && (e.valueAxis ==
        ...
        if (this.prevStartTime != this.startTime || this.prevEndTime != this.endTime) {
            ...
            a.startValue = AmCharts.formatDate(a.startDate,
                b);
        ...
        if (this.prevStartIndex != this.start || this.prevEndIndex != this.end) {
            ...
            if (AmCharts.ifArray(a) && !isNaN(this.start) && !isNaN(this.end)) {
                ...
                (this.startTime = a[this.start].time, this.endTime = a[this.end].time, b.startDate = new Date(this.startTime), b.endDate = new Date(this.endTime));
...
AmCharts.ValueAxis = AmCharts.Class({inherits:AmCharts.AxisBase, construct:function () {
    ...
    if (this.logarithmic && (0 >= this.getMin(0, this.data.length - 1) || 0 >= this.minimum))this.fire("logarithmicAxisFailed", {type:"logarithmicAxisFailed", chart:a}); else {
        ...
        if (!isNaN(this.min) && !isNaN(this.max) && this.foundGraphs &&
            ...
            var l = this.labelFrequency, m = this.showFirstLabel, p = this.showLastLabel, q = 1, n = 0, o = Math.round((this.max - this.min) / this.step) + 1;
            if (!0 == j) {
            ...
            d = 0;
            1 > this.step &&
                -1 < this.step && (e = this.step.toString(), d = -1 != e.indexOf("e-") ? Number(e.split("-")[1]) : e.split(".")[1].length);
            ...
            if (0 < u) {
                ...
                for (e = this.fillAlpha = 0; e < u; e++) {
                    var y = t[e], D = NaN;
                    if (!isNaN(y.toValue)) {
                        var D = this.getCoordinate(y.toValue), v = new this.axisItemRenderer(this, D, "", !0, NaN, NaN, y);
                        this.pushAxisItem(v)
                    }
                    var B = NaN;
            ...
            for (e = n; e < o; e += q)if (n = this.step * e + this.min, n = AmCharts.roundTo(n, this.maxDecCount + 1), !(this.integersOnly && Math.round(n) != n)) {
                ...
                t ? (v = -1 == ("" + n).indexOf("e") ? n.toExponential(15) :
                    "" + n, v = v.split("e"), d = Number(v[0]), v = Number(v[1]), 10 == d && (d = 1, v += 1), v = d + "e" + v, 0 == n && (v = "0"), 1 == n && (v = "1")) : (j && (d = ("" + n).split("."), s.precision = d[1] ? d[1].length : -1), v = this.usePrefixes ? AmCharts.addPrefix(n, a.prefixesOfBigNumbers, a.prefixesOfSmallNumbers, s) : AmCharts.formatNumber(n, s, s.precision));
                ...
                if (n == this.baseValue && "radar" != k) {
                    var O, E, u = this.viW, x = this.viH, n = this.viX, v = this.viY;
        ...
        !this.visible || h ? (b.hide(),
            j.hide(), a.hide()) : (b.show(), j.show(), a.show())
    }
    ...
    "100% stacked" == b && (b = "100%");
    this.stackType = b;
    var d = [], e = [], f = [], g = [], h, j = this.chart.graphs, k, l, m, p = this.baseValue;
    ...
    for (k = this.start; k <= this.end; k++)for (m =
                                                     0; m < j.length; m++)if (h = j[m], !h.hidden && (l = h.type, h.chart == this.chart && (h.valueAxis == this && a == l && h.stackable) && (l = this.data[k].axes[this.id].graphs[h.id], h = l.values.value, !isNaN(h) && (g[k] = isNaN(g[k]) ? Math.abs(h) : g[k] + Math.abs(h), "regular" == b)))) {
        ...
        "column" == a && !isNaN(h) && (l.values.close = h, 0 > h ? (l.values.close = h, isNaN(e[k]) ?
            l.values.open = p : (l.values.close += e[k], l.values.open = e[k]), e[k] = l.values.close) : (l.values.close = h, isNaN(f[k]) ? l.values.open = p : (l.values.close += f[k], l.values.open = f[k]), f[k] = l.values.close))
    }
    for (k = this.start; k <= this.end; k++)for (m = 0; m < j.length; m++)h = j[m], h.hidden || (l = h.type, h.chart == this.chart && (h.valueAxis == this && a == l && h.stackable) && (l = this.data[k].axes[this.id].graphs[h.id], h = l.values.value, isNaN(h) || (d = 100 * (h / g[k]), l.values.percents = d, l.values.total = g[k], "100%" == b && (isNaN(e[k]) && (e[k] = 0), isNaN(f[k]) &&
        (f[k] = 0), 0 > d ? (l.values.close = d + e[k], l.values.open = e[k], e[k] = l.values.close) : (l.values.close = d + f[k], l.values.open = f[k], f[k] = l.values.close)))))
    ...
    this.min = this.getMin(this.start,
        this.end);
    ...
    1 > d ?
        (this.maxDecCount = Math.abs(Math.log(Math.abs(d)) * Math.LOG10E), this.maxDecCount = Math.round(this.maxDecCount), this.step = AmCharts.roundTo(this.step, this.maxDecCount + 1)) : this.maxDecCount = 0;
    ...
    0 ==
        this.min && (this.minReal = d);
    0 == this.min && 1 < this.minReal && (this.minReal = 1);
    0 < this.min && 0 < this.minReal - this.step && (this.minReal = this.min + this.step < this.minReal ? this.min + this.step : this.min);
    d = Math.log(b) * Math.LOG10E - Math.log(a) * Math.LOG10E;
    this.logarithmic && (2 < d ? (this.minReal = this.min = Math.pow(10, Math.floor(Math.log(Math.abs(a)) * Math.LOG10E)), this.max = Math.pow(10, Math.ceil(Math.log(Math.abs(b)) * Math.LOG10E))) : (b = Math.pow(10, Math.floor(Math.log(Math.abs(this.min)) * Math.LOG10E)) / 10, a = Math.pow(10, Math.floor(Math.log(Math.abs(a)) *
    ...
    for (var d, e = a; e <= b; e++) {
        ...
        for (g in f) {
            ...
            if (h.includeInMinMax && (!h.hidden || this.includeHidden)) {
                ...
                var j;
                if (this.minMaxField)j =
                    h[this.minMaxField], j < d && (d = j); else for (var k in h)"percents" != k && "total" != k && (j = h[k], j < d && (d = j))
            }
        }
    }
    return d
    ...
    for (var a, b = this.start; b <= this.end; b++) {
        ...
        for (e in d) {
            ...
            if (f.includeInMinMax && (!f.hidden || this.includeHidden)) {
                ...
                var g;
                if (this.minMaxField)g = f[this.minMaxField], g > a && (a = g); else for (var h in f)"percents" !=
                    h && "total" != h && (g = f[h], g > a && (a = g))
            }
        }
    }
    return a
    ...
    d.position = "V" == this.orientation ? this.reversed ? this.getCoordinate(a) - this.y : this.getCoordinate(b) -
    ...
    if (isNaN(a))return NaN;
    var b = this.rotate, d = this.reversed, e = this.axisWidth, f = this.stepWidth,
        g = this.min, h = this.minReal;
    ...
    var a =
        this.synchronizeWithAxis, b = a.min, d = a.max, a = a.step, e = this.synchronizationMultiplyer;
...
AmCharts.CategoryAxis = AmCharts.Class({inherits:AmCharts.AxisBase, construct:function () {
    ...
    if (AmCharts.ifArray(a)) {
        var b = this.chart, d = this.start, e = this.labelFrequency, f = 0, g = this.end - d + 1,
            h = this.gridCount, j = this.showFirstLabel, k = this.showLastLabel, l, m = "", m = AmCharts.extractPeriod(this.minPeriod);
        l = AmCharts.getPeriodDuration(m.period, m.count);
        var p, q, n, o, r;
        p = this.rotate;
        var s = this.firstDayOfWeek, a = AmCharts.resetDateToMin(new Date(a[a.length - 1].time + 1.05 * l), this.minPeriod, 1, s).getTime();
        this.endTime > a && (this.endTime = a);
        if (this.parseDates && !this.equalSpacing) {
            if (this.timeDifference = this.endTime - this.startTime, d = this.choosePeriod(0), e = d.period, p = d.count, q = AmCharts.getPeriodDuration(e, p),
                ...
                r = !1;
                this.nextPeriod[a] && (r =
                    this.checkPeriodChange(this.nextPeriod[a], 1, o, m));
                var t = !1;
            ...
            if (this.parseDates && this.equalSpacing) {
                ...
                this.timeDifference = this.endTime -
                    this.startTime;
                ...
                s = !1;
                for (this.end -
                         this.start > this.gridCount && (s = !0); g < n; g++)if (o = this.data[g].time, this.checkPeriodChange(e, p, o, m)) {
        ...
        } else if (this.cellWidth =
            this.getStepWidth(g), g < h && (h = g), f += this.start, this.stepWidth = this.getStepWidth(g), 0 < h) {
            h = Math.floor(g / h);
            g = f;
            g / 2 == Math.round(g / 2) && g--;
            0 > g && (g = 0);
        ...
        for (g =
                 0; g < this.data.length; g++)if (j = this.data[g])k = this.parseDates && !this.equalSpacing ? Math.round((j.time - this.startTime) * this.stepWidth + this.cellWidth / 2) : this.getCoordinate(g - f), j.x[this.id] = k
    }
    j = this.guides.length;
    for (g = 0; g < j; g++)k = this.guides[g], n = h = d = NaN, k.toCategory && (n = b.getCategoryIndexByValue(k.toCategory), isNaN(n) || (d = this.getCoordinate(n - f), l = new this.axisItemRenderer(this, d, "", !0, NaN, NaN, k), this.pushAxisItem(l))), k.category && (n = b.getCategoryIndexByValue(k.category), isNaN(n) || (h = this.getCoordinate(n -
    ...
    choosePeriod:function (a) {
        ...
        return this.parseDates &&
            !this.equalSpacing ? (a.getTime() - this.startTime) * this.stepWidth : this.parseDates && this.equalSpacing ? this.getCoordinate(this.chart.getClosestIndex(this.data, "time", a.getTime(), !1, 0, this.data.length - 1) - this.start) : NaN
...
AmCharts.RecAxis = AmCharts.Class({construct:function (a) {
    var b = a.chart, d = a.axisThickness, e = a.axisColor, f = a.axisAlpha, g = a.offset, h = a.dx, j = a.dy, k = a.viX, l = a.viY, m = a.viH, p = a.viW, q = b.container;
...
AmCharts.RecItem = AmCharts.Class({construct:function (a, b, d, e, f, g, h, j, k) {
    b = Math.round(b);
    void 0 == d && (d = "");
    k || (k = 0);
    void 0 == e && (e = !0);
    ...
    this.set = n;
    var o = a.axisThickness, r = a.axisColor, s = a.axisAlpha, t = a.tickLength, u = a.gridAlpha, x = a.gridThickness, y = a.gridColor, D = a.dashLength, v = a.fillColor, B = a.fillAlpha, O = a.labelsEnabled, E = a.labelRotation, U = a.counter, J = a.inside,
        L = a.dx, F = a.dy, Y = a.orientation, K = a.position, Q = a.previousCoord, ea = a.viH, aa = a.viW, ba = a.offset, ca, M;
    if (h) {
    ...
    M = "start";
    f && (M = "middle");
    var R = E * Math.PI / 180, ha, C = 0, w = 0, fa = 0, da = ha = 0;
    "V" == Y && (E = 0);
    if (O)var S = AmCharts.text(q, d, p,
    ...
    if ("H" == Y) {
        ...
        1 == U && (0 < B && !h && Q < aa) && (e = AmCharts.fitToBounds(b, 0, aa), Q = AmCharts.fitToBounds(Q, 0, aa), ha = e - Q, 0 < ha && (fill = AmCharts.rect(q, ha, a.height, v, B), fill.translate(e - ha + L, F),
            n.push(fill)));
        ...
        if (0 <= b && b <= ea +
            1 && (0 < t && (0 < s && b + k <= ea + 1) && (ca = AmCharts.line(q, [0, t], [b + k, b + k], r, s, x), n.push(ca)), 0 < u))M = AmCharts.line(q, [0, L, aa + L], [b, b + F, b + F], y, u, x, D), n.push(M);
        M = "end";
        ...
        w += m / 2;
        "right" == K ? (C += L + aa + ba, w += F, J ? (C -= t + 4, g || (w -= m / 2 + 3)) : (C += t + 4 + o, w -= 2)) : J ? (C += t + 4 - ba, g || (w -= m / 2 + 3),
            h && (C += L, w += F)) : (C += -t - o - 4 - 2 - ba, w -= 2);
    ...
    S && (S.attr({"text-anchor":M}), S.translate(C, w), 0 != E && S.rotate(-E), a.allLabels.push(S), " " != d && (this.label = S));
    a.counter = 0 == U ? 1 : 0;
    a.previousCoord = b;
...
AmCharts.RadAxis = AmCharts.Class({construct:function (a) {
    ...
    if (b) {
        ...
        for (var a = b.chartData, q = a.length, n = 0; n < q; n++) {
            var o = 180 - 360 / q * n, r = g + this.axisWidth * Math.sin(o / 180 * Math.PI), s = h + this.axisWidth * Math.cos(o /
                180 * Math.PI);
            this.set.push(AmCharts.line(b.container, [g, r], [h, s], e, f, d));
            if (k) {
                var t = "start", r = g + (this.axisWidth + j) * Math.sin(o / 180 * Math.PI), s = h + (this.axisWidth + j) * Math.cos(o / 180 * Math.PI);
...
AmCharts.RadItem = AmCharts.Class({construct:function (a, b, d, e, f, g, h) {
    ...
    this.set = e = m.set();
    var p = a.axisColor, q = a.axisAlpha, n = a.tickLength, o = a.gridAlpha, r = a.gridThickness, s = a.gridColor, t = a.dashLength, u = a.fillColor, x = a.fillAlpha, y = a.labelsEnabled, f = a.counter, D = a.inside, v = a.gridType, b = b - a.height, B, g = a.x, O = a.y;
    h ? (y = !0, isNaN(h.tickLength) || (n = h.tickLength),
        void 0 != h.lineColor && (s = h.lineColor), isNaN(h.lineAlpha) || (o = h.lineAlpha), isNaN(h.dashLength) || (t = h.dashLength), isNaN(h.lineThickness) || (r = h.lineThickness), !0 == h.inside && (D = !0)) : d || (o /= 3, n /= 2);
    var E = "end", U = -1;
    D && (E = "start", U = 1);
    if (y) {
    ...
    b = a.y - b;
    if ("polygons" == v) {
        for (var L = [], F = [], Y = a.data.length, d = 0; d < Y; d++)j = 180 - 360 / Y * d, L.push(b * Math.sin(j / 180 * Math.PI)), F.push(b * Math.cos(j /
            180 * Math.PI));
        L.push(L[0]);
        F.push(F[0]);
    ...
    if (1 == f && 0 < x && !h) {
        ...
        } else L = AmCharts.wedge(m, 0, 0, 0, -360, b, b, h, 0, {fill:u, "fill-opacity":x, stroke:0, "stroke-opacity":0, "stroke-width":0});
        e.push(L);
        L.translate(g, O)
    }
...
AmCharts.RadarFill = AmCharts.Class({construct:function (a, b, d, e) {
    var f = Math.max(b, d), b = d = Math.min(b, d), d = a.chart.container, g = e.fillAlpha, h = e.fillColor, f = Math.abs(f) - a.y, b = Math.abs(b) - a.y, j = -e.angle, e = -e.toAngle;
    isNaN(j) && (j = 0);
    isNaN(e) && (e = -360);
    this.set = d.set();
    void 0 == h && (h = "#000000");
    ...
    if ("polygons" == a.gridType) {
        ...
        k.push(k[0]);
        for (m = l; 0 <= m; m--)j =
            180 - 360 / l * m, e.push(b * Math.sin(j / 180 * Math.PI)), k.push(b * Math.cos(j / 180 * Math.PI));
        this.fill = AmCharts.polygon(d, e, k, h, g)
    } else this.fill = AmCharts.wedge(d, 0, 0, j, e - j, f, f, b, 0, {fill:h, "fill-opacity":g, stroke:0, "stroke-opacity":0, "stroke-width":0});
...
AmCharts.AmGraph = AmCharts.Class({construct:function () {
    ...
    this.allBullets = [];
    this.animationArray = [];
    AmCharts.ifArray(this.data) && (b = !1, "xy" == this.chartType ? this.xAxis.axisCreated && this.yAxis.axisCreated &&
        (b = !0) : this.valueAxis.axisCreated && (b = !0), !this.hidden && b && this.createGraph())
    ...
    (this.bulletAlpha = this.lineAlpha);
    ...
    for (var f = this.start; f <= this.end; f++) {
        var g =
            this.data[f].axes[d.id].graphs[this.id], h = g.values, j = h.x, k = h.y, h = d.getCoordinate(j), l = e.getCoordinate(k);
    ...
    for (var a = this.valueAxis.stackType, b = [], d = [], e, f, g = this.start; g <= this.end; g++) {
        ...
        j = "none" ==
            a || "3d" == a ? h.values.value : h.values.close;
    ...
    var a = this.id, b = this.index, d = this.data, e = this.chart.container, f = this.valueAxis, g = this.type, h = this.columnWidth, j = this.width, k = this.height, l = this.y, m = this.rotate, p = this.columnCount, q = AmCharts.toCoordinate(this.cornerRadiusTop, h / 2), n = this.connect, o = [], r = [], s, t, u = this.chart.graphs.length,
        x, y = this.dx / this.depthCount, D = this.dy / this.depthCount, v = f.stackType, B = this.labelPosition, O = this.start, E = this.end, U = this.scrollbar, J = this.categoryAxis, L = this.baseCoord, F = this.negativeBase, Y = this.columnIndex, K = this.lineThickness, Q = this.lineAlpha, ea = this.lineColor, aa = this.dashLength, ba = this.set;
    "above" == B && (B = "top");
    "below" == B && (B = "bottom");
    var ca = 270;
    "horizontal" == this.gradientOrientation && (ca = 0);
    var M = this.chart.columnSpacing, R = J.cellWidth, ha = (R * h - p) / p;
    M > ha && (M = ha);
    var C, w, fa, da = k + 1, S = j + 1, Ga = 0, Oa =
        0, Pa, Qa, Ha, Ia, ob = this.fillColors, Ca = this.negativeFillColors, va = this.negativeLineColor, Da = this.fillAlphas, Ea = this.negativeFillAlphas;
    ...
    if (!U && ("line" == g || "smoothedLine" == g || "step" == g))if (1 == d.length && ("step" != g && "none" == this.bullet) && (this.bullet = "round", this.resetBullet = !0), Ca || void 0 != va) {
        ...
        var pa = f.getCoordinate(wa), hb = f.getCoordinate(f.max);
    ...
    for (N = O; N <= E; N++) {
        ...
        w.index = N;
        var ma = NaN, A = NaN, z = NaN, X = NaN, T = NaN, Ka = NaN, xa = NaN, La = NaN, ya = NaN, V = NaN, W = NaN, ra = NaN,
            sa = NaN, P = NaN, ja = void 0, ta = ob, Fa = Da, Z = ea;
        ...
        if (na) {
            ...
            if ("candlestick" == g || "ohlc" == g)var P = na.close, Sa = na.low, xa = f.getCoordinate(Sa), Ta = na.high, ya = f.getCoordinate(Ta);
            var ia = na.open, z = f.getCoordinate(P);
            ...
            var ma = C.x[J.id], za = Math.round(R / 2), Ua = za;
            ...
            switch (g) {
                case "line":
                    if (isNaN(P))n || (this.drawLineGraph(o, r, ka, la), o = [], r = [], ka = [], la = []); else if (P < F && (w.isNegative = !0), o.push(A), r.push(z), V = A, W = z, ra = A, sa = z, Ra)ka.push(X), la.push(T);
                    break;
                case "smoothedLine":
                    if (isNaN(P))n || (this.drawSmoothedGraph(o,
                        r, ka, la), o = [], r = [], ka = [], la = []); else if (P < F && (w.isNegative = !0), o.push(A), r.push(z), V = A, W = z, ra = A, sa = z, Ra)ka.push(X), la.push(T);
                    break;
                case "step":
                ...
                case "column":
                    if (!isNaN(P)) {
                        P < F && (w.isNegative = !0, Ca && (ta = Ca),
                            void 0 != va && (Z = va));
                        var ib = f.min, jb = f.max;
                        if (!(P < ib && (ia < ib || void 0 == ia) || P > jb && ia > jb))if (m) {
                            if ("3d" == v)var H = z - 0.5 * (h + M) + M / 2 + D * Y, I = X + y * Y; else H = z - (p / 2 - Y) * (h + M) + M / 2, I = X;
                            var G = h, V = A, W = H + h / 2, ra = A, sa = H + h / 2;
                            H + G > k && (G = k - H);
                            0 > H && (G += H, H = 0);
                            var $ = A - X, pb = I, I = AmCharts.fitToBounds(I, 0, j), $ = $ + (pb - I), $ = AmCharts.fitToBounds($, -I, j - I);
                            ...
                            "3d" == v ? (I = A - 0.5 * (h +
                                M) + M / 2 + y * Y, H = T + D * Y) : (I = A - (p / 2 - Y) * (h + M) + M / 2, H = T);
                            G = h;
                            V = I + h / 2;
                            W = z;
                            ra = I + h / 2;
                            ...
                            I + G > j + Y * y && (G = j - I + Y * y);
                            0 > I && (G += I, I = 0);
                            var $ = z - T, qb = H, H = AmCharts.fitToBounds(H, 0, k), $ = $ + (qb - H), $ = AmCharts.fitToBounds($, -H, k - H);
                        ...
                        if (ja) {
                            ...
                            if (!U) {
                                "none" == v && (x = m ? (this.end + 1 - N) * u - b : u * N +
                                    b);
                                ...
                                this.columnsArray.push({column:ja, depth:x});
                                w.x = m ? H + G / 2 : I + G / 2;
                ...
                case "candlestick":
                    if (!isNaN(ia) && !isNaN(Ta) && !isNaN(Sa) && !isNaN(P)) {
                        var Ma, Va;
                        P < ia && (w.isNegative = !0, Ca && (ta =
                            Ca), Ea && (Fa = Ea), void 0 != va && (Z = va));
                        if (m) {
                            ...
                            var ja = new AmCharts.Cuboid(e, G, $, y, D, ta, Fa, K, Z, Q, ca, q, m), Ya, Za;
                            P > ia ? (Ya = [z, ya], Za = [T, xa]) : (Ya = [T, ya], Za = [z, xa]);
                            A < j && 0 < A && (Ma =
                                AmCharts.line(e, [A, A], Ya, Z, Q, K), Va = AmCharts.line(e, [A, A], Za, Z, Q, K))
                        }
                ...
                case "ohlc":
                    if (!isNaN(ia) && !isNaN(Ta) && !isNaN(Sa) && !isNaN(P)) {
                        ...
                        var $a, ab, bb;
                        if (m) {
                            var cb = z - h / 2, cb = AmCharts.fitToBounds(cb, 0, k), kb = AmCharts.fitToBounds(z, 0, k), db = z + h / 2, db = AmCharts.fitToBounds(db,
                                0, k);
                            ab = AmCharts.line(e, [X, X], [cb, kb], Z, Q, K, aa);
                            0 < z && z < k && ($a = AmCharts.line(e, [Ka, La], [z, z], Z, Q, K, aa));
                            bb = AmCharts.line(e, [A, A], [kb, db], Z, Q, K, aa)
                        } else {
                            var eb = A - h / 2, eb = AmCharts.fitToBounds(eb, 0, j), lb = AmCharts.fitToBounds(A, 0, j), fb = A + h / 2, fb = AmCharts.fitToBounds(fb, 0, j);
            ...
            if (!U && !isNaN(P)) {
                ...
                if (this.end - this.start <= mb || 0 == mb) {
                    ...
                    Aa || (Aa = 0);
                    if (this.labelText) {
                        var ga = this.createLabel(w, 0, 0), ua = 0, Ba = 0, nb = ga.getBBox(), Na = nb.width, gb = nb.height;
                        switch (B) {
                            case "left":
                                ua = -(Na / 2 + Aa / 2 + 3);
                                break;
                            ...
                            case "right":
                                ...
                                break;
                            case "bottom":
                                m && "column" == g ? (V = L, 0 > P ? (ua = -6, ga.attr({"text-anchor":"end"})) : (ua = 6, ga.attr({"text-anchor":"start"}))) : (Ba = Aa / 2 + gb / 2, ga.x = -(Na / 2 + 2));
                                break;
                            case "middle":
                                "column" == g && (m ? (ua = -(A - X) / 2 - y, 0 > $ &&
                                    (ua += y), Math.abs(A - X) < Na && !this.showAllValueLabels && (ga.remove(), ga = null)) : (Ba = -(z - T) / 2, 0 > $ && (Ba -= D), Math.abs(z - T) < gb && !this.showAllValueLabels && (ga.remove(), ga = null)))
                        }
    ...
    0 <
        e && !d.animationPlayed && (d.seqAn ? (a.set.hide(), d.animationArray.push(a), e = setTimeout(function () {
        d.animate.call(d)
    }, 1E3 * e / (d.end - d.start + 1) * (b - d.start)), d.timeOuts.push(e)) : d.animate(a))
}, createLabel:function (a, b, d) {
    var e = this.chart, f = this.color;
    void 0 == f && (f = e.color);
    var g = this.fontSize;
    ...
    positiveClip:function (a) {
        ...
        if (1 < a.length) {
            ...
            f.push(h);
            f.push(j);
            var k = this.lineAlpha, l = this.lineThickness, m = this.dashLength, f = this.fillAlphas, p = this.fillColors, q = this.negativeLineColor, n = this.negativeFillColors, o = this.negativeFillAlphas, r = this.baseCoord, s = AmCharts.line(g, a, b, this.lineColor, k, l, m, !1,
                !0);
            h.push(s);
        ...
        if (1 < a.length) {
            ...
            d.push(f);
            d.push(g);
            var h = this.lineAlpha, j = this.lineThickness, d = this.dashLength, k = this.fillAlphas, l = this.fillColors, m = this.negativeLineColor, p = this.negativeFillColors, q = this.negativeFillAlphas, n = this.baseCoord,
        ...
        b && (this.rotate ? (b.translate(-1E3, f), d.translate(-1E3, f)) : (b.translate(e, -1E3), d.translate(e, -1E3)),
            b.animate({opacity:1, translate:e + "," + f}, g, a), d.animate({opacity:1, translate:e + "," + f}, g, a))
    }, animate:function (a) {
        ...
        if ("none" != this.bullet || a.bullet) {
            ...
            a.isNegative &&
                void 0 != this.bulletColorNegative && (k = this.bulletColorNegative);
            void 0 != a.color && (k = a.color);
            f = this.bullet;
            a.bullet && (f = a.bullet);
            var h = this.bulletBorderThickness, l = this.bulletBorderColor, m = this.bulletBorderAlpha, p = this.bulletAlpha, q = a.alpha;
            isNaN(q) || (p = q);
            switch (f) {
                case "round":
        ...
        if (this.customBullet || a.customBullet)if (f = this.customBullet, a.customBullet && (f = a.customBullet), f)j && j.remove(), "function" == typeof f ? (j = new f, j.chart = this.chart, a.bulletConfig && (j.availableSpace = d, j.graph = this, a.bulletConfig.minCoord = this.minCoord - d, j.bulletConfig = a.bulletConfig), j.write(e), j = j.set) :
            (this.chart.path && (f = this.chart.path + f), j = e.image(f, 0, 0, g, g).attr({preserveAspectRatio:!0}), this.centerCustomBullets && (b -= g / 2, d -= g / 2));
        if (j) {
        ...
        if (a) {
            ...
            d = this.showBalloon;
            b.chartCursor && "serial" ==
                this.chartType && (d = !1, !b.chartCursor.valueBalloonsEnabled && this.showBalloon && (d = !0));
        ...
        a && (a = {type:"doubleClickGraphItem", item:a, index:a.index, graph:this, target:this, chart:this.chart}, this.fire("doubleClickGraphItem", a), this.chart.fire("doubleClickGraphItem", a))
    }, zoom:function (a, b) {
        this.start = a;
        this.end = b;
        this.draw()
...
AmCharts.ChartCursor = AmCharts.Class({construct:function () {
    ...
    var a = this.chart, b = this.cursorAlpha, d = a.categoryAxis, e = d.position, f = d.inside, g = d.axisThickness, h = this.categoryBalloon, j, k, l = a.dx, m = a.dy, p = this.x, q = this.y, n = this.width, o = this.height, a = a.rotate, r = d.tickLength;
    h.pointerWidth =
        r;
    ...
    if (a.mouseIsOver) {
        ...
        0 < b && b < this.width && 0 < d && d < this.height ? (this.drawing ? this.rolledOver || a.setMouseCursor("crosshair") : this.pan && (this.rolledOver ||
            a.setMouseCursor("move")), this.rolledOver = !0, this.setPosition()) : this.rolledOver && (this.handleMouseOut(), this.rolledOver = !1)
    ...
    var a = this.chart, b = a.mouseX - this.x, d = a.mouseY - this.y, e = this.vLine, f = this.hLine, b = AmCharts.fitToBounds(b,
        0, this.width), d = AmCharts.fitToBounds(d, 0, this.height);
    ...
    0 < h && 0 <
        j && (d = AmCharts.rect(this.container, h, j, this.cursorColor, this.selectionAlpha), d.translate(f + this.x, g + this.y), this.selection = d)
    ...
    for (var b = this.chart.graphs, d = 0; d < b.length; d++) {
        ...
        if (!e.hidden && e.balloonText) {
            ...
            if (!isNaN(g)) {
                ...
                e = AmCharts.circle(a,
                    this.bulletSize / 2, this.chart.getBalloonColor(e, f), e.cursorBulletAlpha);
                e.translate(j, g);
                this.allBullets.push(e)
            }
        }
    ...
    this.drawingNow && (AmCharts.remove(this.drawingLine), this.drawingLine = AmCharts.line(this.container, [this.x + this.drawStartX, this.x + e], [this.y + this.drawStartY, this.y + f], this.cursorColor,
        1, 1));
    if (this.enabled) {
        void 0 == b && (b = !0);
        this.index = a;
        var g = d.categoryAxis, h = d.dx, j = d.dy, k = this.x, l = this.y, m = this.width, p = this.height, q = this.data[a], n = q.x[g.id], o = d.rotate, r = g.inside, s = this.stepWidth, t = this.categoryBalloon, u = this.firstTime, x = this.lastTime, y = this.cursorPosition, D = g.position, v = this.zooming, B = this.panning, O = d.graphs, E = g.axisThickness;
        if (d.mouseIsOver || v || B || this.forceShow)if (this.forceShow = !1, B) {
            ...
            0 != e && (m = {type:"zoomed", target:this}, m.chart = this.chart, g.parseDates && !g.equalSpacing ? (d + e > x && (e = x - d), v + e < u && (e = u - v), m.start = v + e, m.end = d + e, this.fire(m.type, m)) : k + e >= this.data.length || 0 > l + e || (m.start = l + e, m.end = k + e, this.fire(m.type, m)))
        } else {
            "start" == y && (n -= g.cellWidth / 2);
            "mouse" == y && (n = o ? f - 2 : e - 2);
            if (o) {
                if (0 > n)if (v)n = 0; else {
                    this.hideCursor();
                    return
                }
                if (n > p + 1)if (v)n = p + 1; else {
                    this.hideCursor();
                    return
                }
            } else {
            ...
            u = !0;
            v && (u = !1);
            this.categoryBalloonEnabled && u ? (o ? (r && ("right" == D ? t.setBounds(k, l + j, k + m + h, l + n + j) : t.setBounds(k, l + j, k + m + h, l + n)), "right" == D ? r ? t.setPosition(k + m + h, l + n + j) : t.setPosition(k + m + h + E, l + n + j) : r ? t.setPosition(k, l + n) : t.setPosition(k - E, l + n)) : "top" ==
            ...
            if (O && this.valueBalloonsEnabled && u && d.balloon.enabled) {
                ...
                if (this.oneBalloonOnly)for (var h = Infinity,
                                                 U, u = 0; u < O.length; u++)s = O[u], s.showBalloon && (!s.hidden && s.balloonText) && (t = q.axes[s.valueAxis.id].graphs[s.id], x = t.y, isNaN(x) || (o ? Math.abs(e - x) < h && (h = Math.abs(e - x), U = s) : Math.abs(f - x) < h && (h = Math.abs(f - x), U = s)));
                for (u = 0; u < O.length; u++)if (s = O[u], !(this.oneBalloonOnly && s != U) && (s.showBalloon && !s.hidden && s.balloonText) && (t = q.axes[s.valueAxis.id].graphs[s.id], x = t.y, !isNaN(x))) {
                    ...
                    n && (r = d.getBalloonColor(s, t), n = new AmCharts.AmBalloon, n.chart =
                        d, AmCharts.copyProperties(d.balloon, n), n.setBounds(k, l, k + m, l + p), n.pointerOrientation = "H", n.changeColor(r), void 0 != s.balloonAlpha && (n.fillAlpha = s.balloonAlpha), void 0 != s.balloonTextColor && (n.color = s.balloonTextColor), n.setPosition(h + k, j + l), s = d.formatString(s.balloonText, t, s), "" != s && n.showBalloon(s), !o && n.set && n.set.hide(), g.push({yy:x, balloon:n}))
                }
                o || this.arrangeBalloons()
            }
            b ? (m = {type:"changed"}, m.index = a, m.target = this, m.chart = this.chart, m.zooming = v, m.position = o ? f : e, m.target = this, d.fire("changed", m),
                this.fire("changed", m), this.skipZoomDispatch = !1) : (this.skipZoomDispatch = !0, d.updateLegendValues(a));
    ...
    if (this.drawingNow) {
        ...
        if (2 < Math.abs(e - b) || 2 < Math.abs(f - d))a = {type:"draw", target:this, chart:a, initialX:e, initialY:f, finalX:b, finalY:d}, this.fire(a.type, a)
    }
    if (this.enabled) {
        if (this.pan)this.rolledOver = !1; else if (this.zoomable &&
            this.zooming) {
    ...
    if (this.zoomable || this.pan || this.drawing) {
        ...
        if (0 < e && e < this.width && 0 < f && f < this.height || "fake" ==
            a)this.setPosition(), this.drawing ? (this.drawStartY = f, this.drawStartX = e, this.drawingNow = !0) : this.pan ? (this.zoomable = !1, d.setMouseCursor("move"), this.panning = !0, this.panClickPos = b ? f : e, this.panClickStart = this.start, this.panClickEnd = this.end, this.panClickStartTime = this.startTime, this.panClickEndTime = this.endTime) : this.zoomable && ("cursor" == this.type ? (this.fromIndex = this.index, b ? (this.initialMouse = f, this.selectionPosY = this.linePos) : (this.initialMouse = e, this.selectionPosX = this.linePos)) : (this.initialMouseX =
            e, this.initialMouseY = f, this.selectionPosX = e, this.selectionPosY = f), this.zooming = !0)
    }
}});
AmCharts.SimpleChartScrollbar = AmCharts.Class({construct:function () {
    ...
    if ((a.height = h) && g) {
        ...
        g = e.pathToImages;
        d ? (j = g + "dragIconH.gif", h = a.dragIconWidth, g = a.dragIconHeight) : (j = g +
            "dragIcon.gif", g = a.dragIconWidth, h = a.dragIconHeight);
        d = b.image(j, 0, 0, g, h);
        g = b.image(j, 0, 0, g, h);
    ...
    d = j.x + f;
    e = j.y + g;
    var k = j.width, j = j.height, l = this.rotate, m =
        this.chart, p = this.width, q = this.height, n = m.mouseX, o = m.mouseY;
    a = this.initialMouse;
    ...
    this.rotate ? (g = this.dragIconWidth, h = this.dragIconHeight, e.translate((j - h) / 2, d - g / 2), f.translate((j - h) / 2, d + a.height - g / 2)) : (g = this.dragIconHeight, h = this.dragIconWidth, e.translate(b - h / 2, (j - g) /
        2), f.translate(b + -h / 2 + a.width, (j - g) / 2))
    ...
    iconRollOver:function () {
        ...
        if (!this.resizingRight && !this.resizingLeft) {
            ...
            k ? (a = "y", b = b.mouseY - f / 2 - h, b = AmCharts.fitToBounds(b, 0, this.height - f)) : (a = "x", b = b.mouseX - g / 2 - j, b =
...
AmCharts.ChartScrollbar = AmCharts.Class({inherits:AmCharts.SimpleChartScrollbar, construct:function () {
    ...
    if (this.graph && (a = this.valueAxis, a || (this.valueAxis = a = new AmCharts.ValueAxis, a.visible = !1, a.scrollbar = !0, a.axisItemRenderer = AmCharts.RecItem,
        a.axisRenderer = AmCharts.RecAxis, a.guideFillRenderer = AmCharts.RecFill, a.labelsEnabled = !1, a.chart = b), b = this.unselectedGraph, b || (b = new AmCharts.AmGraph, b.scrollbar = !0, this.unselectedGraph = b), b = this.selectedGraph, !b))b = new AmCharts.AmGraph, b.scrollbar = !0, this.selectedGraph = b;
    this.scrollbarCreated = !0
}, draw:function () {
    var a = this;
    AmCharts.ChartScrollbar.base.draw.call(a);
    a.scrollbarCreated || a.init();
    var b = a.chart, d = b.chartData, e = a.categoryAxis, f = a.rotate, g = a.x, h = a.y, j = a.width, k = a.height, l = b.categoryAxis,
        m = a.set;
    e.setOrientation(!f);
    ...
    e.zoom(0, d.length - 1);
    if (l = a.graph) {
        var p = a.valueAxis, q = l.valueAxis;
        p.id = q.id;
        p.rotate = f;
        p.setOrientation(f);
        p.width = j;
        ...
        for (var g = Infinity, h = -Infinity, n = 0; n < d.length; n++) {
            var o = d[n].axes[q.id].graphs[l.id].values, r;
        ...
        Infinity != g && (p.minimum = g);
        -Infinity != h && (p.maximum = h + 0.1 * (h - g));
...
AmCharts.polygon = function (a, b, d, e, f, g, h, j, k) {
    ...
    void 0 == h && (h = l);
    for (var f = {fill:l, stroke:h, "fill-opacity":f, "stroke-width":g, "stroke-opacity":j}, g = AmCharts.dx, h = AmCharts.dy, j = Math.round, l = "M" + (j(b[0]) + g) + "," + (j(d[0]) + h), p = 1; p < b.length; p++)l += " L" + (j(b[p]) + g) + "," + (j(d[p]) + h);
    a = a.path(l + " Z").attr(f);
...
AmCharts.triangle = function (a, b, d, e, f, g, h, j) {
    ...
    void 0 == h && (h = "#000");
    void 0 == j && (j = 0);
    var e = {fill:e, stroke:h, "fill-opacity":f, "stroke-width":g, "stroke-opacity":j}, b = b / 2, k;
...
AmCharts.line = function (a, b, d, e, f, g, h, j, k) {
    j = "none";
    void 0 != h && (j = h);
    g = {fill:"none", "stroke-dasharray":j, "stroke-width":g};
    isNaN(f) || (g["stroke-opacity"] = f);
    e && (g.stroke = e);
...
AmCharts.wedge = function (a, b, d, e, f, g, h, j, k, l) {
    var m = Math.round, g = m(g), h = m(h), j = m(j), p = m(h / g * j), q = AmCharts.VML;
    -359.9 >= f && (f = -359.9);
    var n = 1 / 180 * Math.PI, o = b + Math.cos(e * n) * j, r = d + Math.sin(-e * n) * p, s = b + Math.cos(e * n) * g, t = d + Math.sin(-e * n) * h, u = b + Math.cos((e + f) * n) * g, x = d + Math.sin((-e - f) * n) * h, y = b + Math.cos((e + f) * n) * j, n = d + Math.sin((-e - f) * n) * p, D = {fill:AmCharts.adjustLuminosity(l.fill, -0.2), "stroke-opacity":0}, v = 0;
    180 < Math.abs(f) && (v = 1);
    var e = a.set(), B;
    q && (o = m(10 * o), s = m(10 * s), u = m(10 * u), y = m(10 * y), r = m(10 * r), t = m(10 *
        t), x = m(10 * x), n = m(10 * n), b = m(10 * b), k = m(10 * k), d = m(10 * d), g *= 10, h *= 10, j *= 10, p *= 10, 1 > Math.abs(f) && (1 >= Math.abs(u - s) && 1 >= Math.abs(x - t)) && (B = !0));
    if (0 < k) {
        var O;
        q ? (path = " M" + o + "," + (r + k) + " L" + s + "," + (t + k), B || (path += " A" + (b - g) + "," + (k + d - h) + "," + (b + g) + "," + (k + d + h) + "," + s + "," + (t + k) + "," + u + "," + (x + k)), path += " L" + y + "," + (n + k), 0 < j && (B || (path += " B" + (b - j) + "," + (k + d - p) + "," + (b + j) + "," + (k + d + p) + "," + y + "," + (k + n) + "," + o + "," + (k + r)))) : (path = " M" + o + "," + (r + k) + " L" + s + "," + (t + k), path += " A" + g + "," + h + ",0," + v + ",1," + u + "," + (x + k) + " L" + y + "," + (n + k),
            0 < j && (path += " A" + j + "," + p + ",0," + v + ",0," + o + "," + (r + k)));
        path += " Z";
    ...
    q ? (B || (O = " A" + m(b - g) + "," + m(d - h) + "," + m(b + g) + "," + m(d + h) + "," + m(s) + "," + m(t) + "," + m(u) + "," + m(x)), g = " M" + m(o) + "," + m(r) + " L" +
        m(s) + "," + m(t) + O + " L" + m(y) + "," + m(n)) : g = " M" + o + "," + r + " L" + s + "," + t + (" A" + g + "," + h + ",0," + v + ",1," + u + "," + x) + " L" + y + "," + n;
...
AmCharts.AmPieChart = AmCharts.Class({inherits:AmCharts.AmChart, construct:function () {
    ...
    if (AmCharts.ifArray(b)) {
        ...
        a.chartDataLabels = [];
        a.ticks = [];
        var p, q, n, o = AmCharts.toNumber(a.labelRadius), r = a.measureMaxLabel();
        ...
        for (m = 0; m < b.length; m++)if (f = b[m], !0 != f.hidden && 0 < f.percents) {
            var s = 360 * -f.percents / 100, k = Math.cos((g + s / 2) / 180 * Math.PI), r = Math.sin((-g - s / 2) / 180 * Math.PI) * (l / n), j = {fill:f.color, stroke:a.outlineColor, "stroke-width":a.outlineThickness, "stroke-opacity":a.outlineAlpha};
    ...
    for (var a = this.chartData, b = 0; b < a.length; b++)if (this.chartDataLabels[b]) {
        var d = a[b], e = d.ty, f = this.radiusReal, e = AmCharts.line(this.container, [this.pieXReal + d.ix * f, d.tx, d.tx2], [this.pieYReal +
    ...
    checkOverlapping:function (a, b, d, e, f) {
        ...
        a.labelQuarter == d && (!a.hidden && !b.hidden && g) && (f = f.getBBox(), d = {}, d.width = f.width, d.height = f.height, d.y = a.ty,
            d.x = a.tx, a = g.getBBox(), g = {}, g.width = a.width, g.height = a.height, g.y = b.ty, g.x = b.tx, AmCharts.hitTest(d, g) && (e = !0));
        return e
    ...
    startSequenced:function () {
        ...
        1 == b ? (a.pulled = !0, this.pullOutOnlyOne && this.pullInAll(a.index), a = {type:"pullOutSlice", dataItem:a,
            chart:this}) : (a.pulled = !1, a = {type:"pullInSlice", dataItem:a, chart:this});
        this.fire(a.type, a)
        ...
        if (void 0 != b) {
            ...
            1 < b && (this.groupValue =
                0, this.removeSmallSlices(), a.push({title:this.groupedTitle, value:this.groupValue, percents:100 * (this.groupValue / e), pulled:this.groupedPulled, color:this.groupedColor, url:this.groupedUrl, description:this.groupedDescription, alpha:this.groupedAlpha}));
        ...
        for (var a =
            this.chartData, b = 0, d = 0; d < a.length; d++) {
            var e = a[d];
...
AmCharts.AmDObject = AmCharts.Class({construct:function (a, b) {
    ...
    for (var e in a) {
        var f =
            e, g = a[e], d = AmCharts.getEffect(d);
    ...
    getBox:function (a) {
        ...
        for (var b = a.split(" "), a = "", d, e = Math.round, f = 0; f < b.length; f++) {
            var g = b[f], h = g.substring(0,
                1), g = g.substring(1), j = g.split(","), k = e(j[0]) + "," + e(j[1]);
            "M" == h && (a += " m " + k);
            "L" == h && (a += " l " + k);
            "Z" == h && (a += " x e");
            if ("Q" == h) {
                var l = d.length, m = d[l - 1], p = j[0], q = j[1], k = j[2], n = j[3];
                d = e(d[l - 2] / 3 + 2 / 3 * p);
                m = e(m / 3 + 2 / 3 * q);
                p = e(2 / 3 * p + k / 3);
                q = e(2 / 3 * q + n / 3);
        ...
        var g = this, h = a.node;
        if ("translate" == b) {
            var j = d.split(","), b = j[1], d = h.offsetTop, h = {obj:a, frame:0, attribute:"left", from:h.offsetLeft,
                to:j[0], time:e, effect:f};
            g.animations.push(h);
        ...
        for (var a = this.animations.length - 1; 0 <= a; a--) {
            ...
            if (e <= d) {
                b.frame++;
                var h = Number(b.from), j = Number(b.to) - h, b = this.D[b.effect](0, e,
                    h, j, d);
        ...
        e.backgroundColor = f;
        e.paddingLeft = 1;
        var f = b * Math.PI / 180, g = Math.cos(f), h = Math.sin(f), j = this.removePx(e.left), k = this.removePx(e.top), l = d.offsetWidth, d = d.offsetHeight, m = b / Math.abs(b);
        e.left = j + l / 2 - l / 2 * Math.cos(f) -
            m * d / 2 * Math.sin(f) + 3;
...
AmCharts.SVGRenderer = AmCharts.Class({construct:function (a) {
    ...
    for (var a = this.animations.length - 1; 0 <= a; a--) {
        ...
        if (e <= d) {
            b.frame++;
            if ("translate" == g)var h = b.from.split(","), g = Number(h[0]), h = Number(h[1]), j = b.to.split(","), k = Number(j[0]), j = Number(j[1]), k = 0 ==
                k - g ? k : Math.round(this.D[b.effect](0, e, g, k - g, d)), b = 0 == j - h ? j : Math.round(this.D[b.effect](0, e, h, j - h, d)), g = "transform", b = "translate(" + k + "," + b + ")"; else h = Number(b.from), k = Number(b.to), k -= h, b = this.D[b.effect](0, e, h, k, d), 0 == k && this.animations.splice(a, 1);
            this.setAttr(f, g, b)
    ...
    if (!isNaN(e)) {
        var h = 0, j = 0, k = 0, l = 0;
        90 ==
            e ? k = 100 : 270 == e ? l = 100 : 180 == e ? h = 100 : 0 == e && (j = 100);
        b.setAttribute("x1", h + "%");
        b.setAttribute("x2", j + "%");
        b.setAttribute("y1", k + "%");
        b.setAttribute("y2", l + "%")
